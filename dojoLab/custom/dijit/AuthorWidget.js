...
define([
    ...
    "dojo/text!customDijit/templates/AuthorWidget.html"]
    ,function(declare, baseFx, lang, domStyle, mouse, on, registry, _WidgetBase, _TemplatedMixin,_WidgetsInTemplateMixin, template){
    return declare([_WidgetBase, _TemplatedMixin,_WidgetsInTemplateMixin], {
        ...
        avatar: require.toUrl("./themes/default/images/personDefault.png"),
        bio: "",
		...
		postCreate: function(){
		    ...
		    this.own(
		    	...
		    	// on(button, mouse.click, lang.hitch(this, "_buttonClick"))
		    );

		    on(button, "click", lang.hitch(this, "_buttonClick"));
		},
		_buttonClick: function() {
			console.log('hello dijit button!');
		},
